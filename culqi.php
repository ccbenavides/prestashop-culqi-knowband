...
class Culqi extends PaymentModule
{
    ...
    const MODULE_AUTHOR = "Team Culqi (Brayan Cruces, Willy Aguirre) - Space-Kid  configurado por christian benavides";
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $newOption->setModuleName($this->name)
                ->setCallToActionText($this->trans('Pagar con tarjeta de credito', array(), 'Pagar con tarjeta de credito'))
